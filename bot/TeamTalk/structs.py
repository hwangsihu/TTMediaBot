...
class EventType(Enum):
    ...
    SOUNDDEVICE_ADDED = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_ADDED
    SOUNDDEVICE_REMOVED = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_REMOVED
    SOUNDDEVICE_UNPLUGGED = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_UNPLUGGED
    SOUNDDEVICE_NEW_DEFAULT_INPUT = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_NEW_DEFAULT_INPUT
    SOUNDDEVICE_NEW_DEFAULT_OUTPUT = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_NEW_DEFAULT_OUTPUT
    SOUNDDEVICE_NEW_DEFAULT_INPUT_COMDEVICE = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_NEW_DEFAULT_INPUT_COMDEVICE
    SOUNDDEVICE_NEW_DEFAULT_OUTPUT_COMDEVICE = TeamTalkPy.ClientEvent.CLIENTEVENT_SOUNDDEVICE_NEW_DEFAULT_OUTPUT_COMDEVICE
